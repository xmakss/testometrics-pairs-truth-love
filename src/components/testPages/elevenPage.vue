<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/hobby.jpg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Что вам больше всего нравится делать вместе?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Исследовать новые места и культуры', key: '1'},
        {name: 'Смотреть фильмы или сериалы, обнимаясь на диване', key: '2'},
        {name: 'Заниматься каким-то совместным проектом или творчеством', key: '3'},
        {name: 'Готовить и экспериментировать с рецептами', key: '4'}
      ]
    }
  },
  methods: {
