<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/lotery.jpeg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Представьте, что вы выиграли в лотерею. Как бы вы предпочли потратить эти деньги?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Купили бы дом мечты или квартиру', key: '1'},
        {name: 'Инвестировали бы в свое образование или бизнес', key: '2'},
        {name: 'Пожертвовали бы часть суммы на благотворительность', key: '3'},
        {name: 'Устроили бы кругосветное путешествие', key: '4'}
      ]
    }
  },
  methods: {
