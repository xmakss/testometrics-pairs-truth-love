<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/problems.png" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Как ваш партнер реагирует, когда вы рассказываете о своих проблемах?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Внимательно слушает и поддерживает меня', key: '1'},
        {name: 'Пытается решить мою проблему или дать совет', key: '2'},
        {name: 'Сочувствует, но предпочитает держать дистанцию от чужих проблем', key: '3'},
        {name: 'Тоже делится своими проблемами, и мы ищем решения вместе', key: '4'}
      ]
    }
  },
  methods: {
