<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/pet.jpg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Как вы относитесь к питомцам и хотели бы завести общего?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Обожаем животных и мечтаем о большой семье питомцев', key: '1'},
        {name: 'Открыты к идее, но нужно всё хорошо обдумать', key: '2'},
        {name: 'Уже есть питомец, и мы считаем его полноценным членом семьи', key: '3'},
        {name: 'Пока держимся от этой идеи подальше, хотя и не исключаем на будущее', key: '4'}
      ]
    }
  },
  methods: {
