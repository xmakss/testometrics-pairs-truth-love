<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/important.jpg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      ...
      womanAnswer: '',
      answers: [
        {name: 'Много обсуждаем и анализируем все возможные варианты', key: '1'},
        {name: 'Следуем интуиции и тому, что кажется правильным', key: '2'},
        {name: 'Принимаем решения самостоятельно, но учитываем мнение партнера', key: '3'},
        {name: 'Зависит от ситуации, иногда быстро решаем, иногда взвешиваем все за и против', key: '4'}
      ]
    }
  },
  methods: {
