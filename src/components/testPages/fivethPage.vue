<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/stress.jpg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Как вы оба реагируете на стресс или трудные периоды?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Старайтесь поддержать друг друга и справляться вместе', key: '1'},
        {name: 'Ищем утешение в индивидуальных хобби или занятиях', key: '2'},
        {name: 'Обсуждаем проблемы и пытаемся найти системное решение', key: '3'},
        {name: 'Немного отстраняемся, чтобы дать пространство и время на восстановление', key: '4'}
      ]
    }
  },
  methods: {
