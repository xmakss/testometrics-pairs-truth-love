<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/best_pair.jpeg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Что для вас означает быть "лучшей половинкой"?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Быть поддержкой и самостоятельной личностью', key: '1'},
        {name: 'Делать вторую половинку счастливой', key: '2'},
        {name: 'Поддерживать и развивать отношения', key: '3'},
        {name: 'Быть особенной и неповторимой', key: '4'},
      ]
    }
  },
  methods: {
