<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/money.jpg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Если бы вы нашли дополнительный источник дохода, как бы вы его использовали?',
      details: '',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Сберегли бы на будущее важное событие или покупку', key: '1'},
        {name: 'Потратили бы на совместное хобби или увлечение', key: '2'},
        {name: 'Инвестировали бы в развитие собственных проектов или бизнеса', key: '3'},
        {name: 'Использовали бы на путешествия и новые впечатления', key: '4'}
      ]
    }
  },
  methods: {
