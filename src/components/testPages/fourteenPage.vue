<template>
  <div>
    <img class="mt-2 mb-2" alt="I love you" src="../../assets/hobby-one-partner.jpg" width="600" height="400">
...
export default {
  ...
  data() {
    return {
      question: 'Вы узнали о новом увлечении вашего партнера, как вы отреагируете?',
      ...
      womanAnswer: '',
      answers: [
        {name: 'Поддержу и, возможно, присоединюсь, если это покажется интересным', key: '1'},
        {name: 'Поинтересуюсь, но предоставлю ему/ей свободу в этом', key: '2'},
        {name: 'Буду рад(а) за него/неё и порекомендую поделиться новым опытом со мной', key: '3'},
        {name: 'Выразлю восхищение и интерес, предложу совместную деятельность', key: '4'}
      ]
    }
  },
  methods: {
